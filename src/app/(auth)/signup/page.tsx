    ...
    <div className="flex min-h-screen items-center justify-center p-4 bg-neutral-50 dark:bg-neutral-950">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Bergabunglah dengan Community OS untuk mengelola organisasi lokal Anda
          </CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <p className="text-center text-sm text-neutral-500 dark:text-neutral-400">
              Sudah memiliki akun?{' '}
              <Link href="/login" className="font-semibold text-neutral-900 hover:underline dark:text-neutral-100">
                Masuk di sini
              </Link>
            </p>
          </CardFooter>
